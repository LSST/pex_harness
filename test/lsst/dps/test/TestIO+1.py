...
# Get the policies
outputPolicy = lsst.mwi.policy.Policy.createPolicy("test/policy/output+1.policy")
inputPolicy = lsst.mwi.policy.Policy.createPolicy("test/policy/input+1.policy")
